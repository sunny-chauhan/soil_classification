...
#             # Show additional information based on soil type
#             try:
#                 # Construct the file path for the HTML templates
#                 template_path = os.path.join("templates", f"{soil_type.lower().replace(' ', '_')}.html")
...
#                 else:
#                     st.error(f"Template for {soil_type} not found.")
#             except Exception as e:
#                 st.error(f"Error loading the template: {e}")
...
#         os.makedirs("templates")  # Ensure templates directory exists
#     main()
